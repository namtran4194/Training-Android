package com.namtran.lazada.view.hienthisanpham.chitietsanpham.fragment;
...
public class FragmentChiTietSP extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        View v = inflater.inflate(R.layout.fragment_chitietsanpham_slider, container, false);

        Bundle bundle = getArguments();
        String link = bundle.getString("LINKANH"); // link ảnh truyền từ ChiTietSanPhamActivity
